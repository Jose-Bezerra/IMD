...
public class Cozinha {
  ...
  private HashMap<String, Float> estoque; // <String: Nome do ingrediente, Float: Quantidade em estoque>
  ...
  void preparaReceita(Receita receita) throws Exception {
    System.out.println("Preparando " + receita.getNome());
    if (!receitas.contains(receita)) {
      throw new Exception("A cozinha não sabe preparar esta receita");
    }
